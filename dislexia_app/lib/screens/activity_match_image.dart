...
/// 5 questões, +20 pontos por acerto, -10 por erro (mínimo 0).
...
class _ActivityMatchImageState extends State<ActivityMatchImage> {
  ...
  Future<void> _configureTts() async {
    ...
    if (!success) {
      debugPrint('AVISO: TTS pode não estar em português brasileiro!');
    }
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Opções de palavras (4 botões em grid 2x2)
              Expanded(
                flex: 2,

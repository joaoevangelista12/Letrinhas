...
void main() {
  group('UserProvider', () {
    ...
    test('deve atualizar progresso corretamente', () {
      ...
      expect(userProvider.level, 2); // 150/100 = 1, +1 = 2
      expect(userProvider.levelProgress, 0.5); // 50/100
    });

    test('deve calcular nível corretamente com vários valores', () {
      // Nível 1
      userProvider.updateProgress(totalPoints: 0, activitiesCompleted: 0);
      expect(userProvider.level, 1);
